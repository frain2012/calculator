        ...
        <div class="navbar-fir navbar-fixed-side" tabindex="0" style="overflow: hidden; outline: none;">
            ...
            <nav id="hdtnavbar">
                <ul>
                    ...
                    <li class="active"><a href="/v2/setting"><span class="glyphicon glyphicon-edit"></span>设置</a></li>
                    <li class=""><a href="/v2/capital/balance"><span class="glyphicon glyphicon-yen"></span>资产</a></li>
                    <li class=""><a href="/v2/account/password"><span class="glyphicon glyphicon-user"></span>账号</a></li>

                    <li class=""><a href="/v2/account/switch"><span class="glyphicon glyphicon-transfer"></span>切换</a></li>
                    <li class=""><a href="/logout"><span class="glyphicon glyphicon-off"></span>退出</a></li>
                </ul>
            </nav>
        </div><!--end .navbar-fir-->
